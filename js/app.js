import { initAuth, onAuthChange, signInWithGoogle, signOut, updateDisplayName, getUser } from './auth.js';
...
// ============ 認証 ============
$('#btn-google-login').addEventListener('click', () => signInWithGoogle().catch((e) => alert('ログインに失敗しました: ' + e.message)));
